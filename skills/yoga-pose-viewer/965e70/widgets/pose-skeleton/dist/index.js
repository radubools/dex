...
var Xr = class extends Vt {
...
}, oi = /*@__PURE__*/ new q(), si = /*@__PURE__*/ new q(), ci = /*@__PURE__*/ new qt(), li = /*@__PURE__*/ new Pr(), ui = /*@__PURE__*/ new gr(), di = /*@__PURE__*/ new q(), fi = /*@__PURE__*/ new q(), pi = class extends xn {
	...
	computeLineDistances() {
		...
		if (e.index === null) {
			...
			e.setAttribute("lineDistance", new fr(n, 1));
...
var hi = /*@__PURE__*/ new q(), gi = /*@__PURE__*/ new q(), _i = class extends pi {
	constructor(e, t) {
	...
	constructor(e = 1, t = 1, n = 1, r = 32, i = 1, a = !1, o = 0, s = Math.PI * 2) {
		...
		_(), a === !1 && (e > 0 && v(!0), t > 0 && v(!1)), this.setIndex(l), this.setAttribute("position", new fr(u, 3)), this.setAttribute("normal", new fr(d, 3)), this.setAttribute("uv", new fr(f, 2));
		function _() {
...
function Ei(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Oi(i)) i.isRenderTargetTexture ? (H("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var ji = {
	...
	constructor(e) {
		super(), this.isShaderMaterial = !0, this.type = "ShaderMaterial", this.defines = {}, this.uniforms = {}, this.uniformsGroups = [], this.vertexShader = Mi, this.fragmentShader = Ni, this.linewidth = 1, this.wireframe = !1, this.wireframeLinewidth = 1, this.fog = !1, this.lights = !1, this.clipping = !1, this.forceSinglePass = !0, this.extensions = {
			clipCullDistance: !1,
			multiDraw: !1
...
var Bi = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = zi(t, this.TimeBufferType), this.values = zi(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
...
Gi.prototype.ValueTypeName = "", Gi.prototype.TimeBufferType = Float32Array, Gi.prototype.ValueBufferType = Float32Array, Gi.prototype.DefaultInterpolation = R;
var Ki = class extends Gi {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Ki.prototype.ValueTypeName = "bool", Ki.prototype.ValueBufferType = Array, Ki.prototype.DefaultInterpolation = Me, Ki.prototype.InterpolantFactoryMethodLinear = void 0, Ki.prototype.InterpolantFactoryMethodSmooth = void 0;
var qi = class extends Gi {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
...
Xi.prototype.ValueTypeName = "quaternion", Xi.prototype.InterpolantFactoryMethodSmooth = void 0;
var Zi = class extends Gi {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Zi.prototype.ValueTypeName = "string", Zi.prototype.ValueBufferType = Array, Zi.prototype.DefaultInterpolation = Me, Zi.prototype.InterpolantFactoryMethodLinear = void 0, Zi.prototype.InterpolantFactoryMethodSmooth = void 0;
var Qi = class extends Gi {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
...
var $i = class extends xn {
...
}, ea = /*@__PURE__*/ new qt(), ta = /*@__PURE__*/ new q(), na = /*@__PURE__*/ new q(), ra = class {
	constructor(e) {
	...
	updateMatrices(e) {
		...
		ta.setFromMatrixPosition(e.matrixWorld), t.position.copy(ta), na.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(na), t.updateMatrixWorld(), ea.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(ea, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(ea);
	}
	getViewport(e) {
...
}, ia = /*@__PURE__*/ new q(), aa = /*@__PURE__*/ new Tt(), oa = /*@__PURE__*/ new q(), sa = class extends xn {
	constructor() {
...
}, ca = /*@__PURE__*/ new q(), la = /*@__PURE__*/ new K(), ua = /*@__PURE__*/ new K(), da = class extends sa {
	...
	constructor() {
		super(new fa(-5, 5, 5, -5, .5, 500)), this.isDirectionalLightShadow = !0;
	}
}, ma = class extends $i {
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(xn.DEFAULT_UP), this.updateMatrix(), this.target = new xn(), this.shadow = new pa();
	}
	dispose() {
...
}, ga = -90, _a = 1, va = class extends xn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new da(ga, _a, e, t);
		r.layers = this.layers, this.add(r);
		let i = new da(ga, _a, e, t);
		i.layers = this.layers, this.add(i);
		let a = new da(ga, _a, e, t);
		a.layers = this.layers, this.add(a);
		let o = new da(ga, _a, e, t);
		o.layers = this.layers, this.add(o);
		let s = new da(ga, _a, e, t);
		s.layers = this.layers, this.add(s);
		let c = new da(ga, _a, e, t);
...
}, ba = "\\[\\]\\.:\\/", xa = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), Sa = "[^\\[\\]\\.:\\/]", Ca = "[^" + ba.replace("\\.", "") + "]", wa = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", Sa), Ta = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", Ca), Ea = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", Sa), Da = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", Sa), Oa = RegExp("^" + wa + Ta + Ea + Da + "$"), ka = [
	"material",
	"materials",
	"bones",
	"map"
	...
	static parseTrackName(e) {
		...
		if (r !== void 0 && r !== -1) {
			...
			ka.indexOf(e) !== -1 && (n.nodeName = n.nodeName.substring(0, r), n.objectName = e);
		}
...
ja.Composite = Aa, ja.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
...
var Ma = /*@__PURE__*/ new qt(), Na = class {
	...
	intersectObject(e, t = !0, n = []) {
		return Fa(e, this, n, t), n.sort(Pa), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) Fa(e[r], this, n, t);
		return n.sort(Pa), n;
	}
};
function Pa(e, t) {
...
function Fa(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) Fa(r[e], t, n, !0);
	}
}
var Ia = class {
...
var La = class extends _i {
	constructor(e = 10, t = 10, n = 4473924, r = 8947848) {
		...
		let l = new wr();
		l.setAttribute("position", new fr(s, 3)), l.setAttribute("color", new fr(c, 3));
		let u = new ai({
			vertexColors: !0,
			toneMapped: !1
		});
	...
	constructor(e = 1) {
		...
		r.setAttribute("position", new fr(t, 3)), r.setAttribute("color", new fr(n, 3));
		let i = new ai({
			vertexColors: !0,
			toneMapped: !1
		});
	...
	setColors(e, t, n) {
		let r = new X(), i = this.geometry.attributes.color.array;
...
var Z = {
	...
	points: {
		uniforms: /*@__PURE__*/ Di([Q.points, Q.fog]),
	...
	depth: {
		uniforms: /*@__PURE__*/ Di([Q.common, Q.displacementmap]),
	...
	sprite: {
		uniforms: /*@__PURE__*/ Di([Q.sprite, Q.fog]),
...
Wa.physical = {
	uniforms: /*@__PURE__*/ Di([Wa.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Ga = {
	...
	b: 0,
	g: 0
}, Ka = /*@__PURE__*/ new qt(), qa = /*@__PURE__*/ new J();
...
function Ja(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new qr(new Si(1, 1, 1), new Pi({
			name: "BackgroundCubeMaterial",
			uniforms: Ei(Wa.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(Ka.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(qa), l.material.toneMapped = Y.getTransfer(i.colorSpace) !== ze, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new qr(new wi(2, 2), new Pi({
			name: "BackgroundMaterial",
			uniforms: Ei(Wa.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(Ga, Ai(e)), n.buffers.color.setClear(Ga.r, Ga.g, Ga.b, r, a);
	}
	function _() {
...
var $a = 4, eo = [
	...
	.526,
	.582
], to = 20, no = 256, ro = /*@__PURE__*/ new fa(), io = /*@__PURE__*/ new X(), ao = null, oo = 0, so = 0, co = !1, lo = /*@__PURE__*/ new q(), uo = class {
	constructor(e) {
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(ao, oo, so), this._renderer.xr.enabled = co, e.scissorTest = !1, mo(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = fo(r)), this._blurMaterial = go(r, e, t), this._ggxMaterial = ho(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
	...
	_sceneToCubeUV(e, t, n, r, i) {
		...
		c.getClearColor(io), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new qr(new Si(), new Fr({
		...
		for (let t = 0; t < 6; t++) {
			...
			mo(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = vo()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = _o());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		mo(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, ro);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - $a ? n - d + $a : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, mo(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, ro), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, mo(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, ro);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / 39, p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : to;
		m > to && H(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${to}`);
		let h = [], g = 0;
		for (let e = 0; e < to; ++e) {
		...
		mo(t, 3 * v * (r > _ - $a ? r - _ + $a : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, ro);
	}
};
function fo(e) {
	let t = [], n = [], r = [], i = e, a = e - $a + 1 + eo.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - $a ? s = eo[o - e + $a - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new wr();
		h.setAttribute("position", new lr(f, 3)), h.setAttribute("uv", new lr(p, 2)), h.setAttribute("faceIndex", new lr(m, 1)), r.push(new qr(h, null)), i > $a && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function go(e, t, n) {
	let r = new Float32Array(to), i = new q(0, 1, 0);
	return new Pi({
...
var bo = class extends Wt {
	...
	fromEquirectangularTexture(e, t) {
		...
		return t.minFilter === 1008 && (t.minFilter = c), new va(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new uo(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new uo(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function ko(e, t, n, r, i, a) {
	...
	let l = new Fi({
		...
		depthTest: !1,
		depthWrite: !1
	}), u = new qr(c, l), d = new fa(-1, 1, 1, -1, 0, 1), f = null, p = null, m = !1, h, g = null, _ = [], y = !1;
...
var Ao = /*@__PURE__*/ new Vt(), jo = /*@__PURE__*/ new yi(1, 1), Mo = /*@__PURE__*/ new Gt(), No = /*@__PURE__*/ new Kt(), Po = /*@__PURE__*/ new vi(), Fo = [], Io = [], Lo = /* @__PURE__ */ new Float32Array(16), Ro = /* @__PURE__ */ new Float32Array(9), zo = /* @__PURE__ */ new Float32Array(4);
function Bo(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Fo[i];
...
function Jo(e, t) {
	...
	if (r === void 0) {
		...
		if (Vo(n, r)) return;
		zo.set(r), e.uniformMatrix2fv(this.addr, !1, zo), Ho(n, r);
	}
}
function Yo(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Vo(n, r)) return;
		Ro.set(r), e.uniformMatrix3fv(this.addr, !1, Ro), Ho(n, r);
	}
}
function Xo(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (Vo(n, r)) return;
		Lo.set(r), e.uniformMatrix4fv(this.addr, !1, Lo), Ho(n, r);
	}
}
function Zo(e, t) {
	let n = this.cache;
...
function as(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (jo.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = jo) : a = Ao, n.setTexture2D(t || a, i);
}
function os(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
...
function cs(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Mo, i);
}
function ls(e) {
	switch (e) {
		case 5126: return Wo;
...
function Ts(e, t, n) {
	...
	Vo(r, a) || (e.uniform1iv(this.addr, a), Ho(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? jo : Ao;
...
var qs = /*@__PURE__*/ new q();
function Js() {
	return Y.getLuminanceCoefficients(qs), [
...
function Cc(e, t, n, r, i, a) {
	let o = new an(), s = new bc(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
...
function Dc() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || Tc), r.length > 1 && r.sort(t || Ec), i.length > 1 && i.sort(t || Ec), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
var Ic = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Lc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Rc = [
	...
	/*@__PURE__*/ new q(0, -1, 0),
	/*@__PURE__*/ new q(0, -1, 0)
], Bc = /*@__PURE__*/ new qt(), Vc = /*@__PURE__*/ new q(), Hc = /*@__PURE__*/ new q();
function Uc(e, t, n) {
	let r = new ii(), i = new K(), o = new K(), s = new Ht(), l = new Li(), u = new Ri(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Pi({
			...
			if (p.camera._reversedDepth = b, p.map === null || h === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Wt(i.x, i.y, {
						...
						magFilter: c,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new yi(i.x, i.y, _), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = D, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a;
				} else d.isPointLight ? (p.map = new bo(i.x), p.map.depthTexture = new bi(i.x, g)) : (p.map = new Wt(i.x, i.y), p.map.depthTexture = new yi(i.x, i.y, g)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = D, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = c, p.map.depthTexture.magFilter = c) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a);
			...
			if (n.isDepthTexture) u = j(n.format === O, n.type), _ && (g ? d.texStorage2D(e.TEXTURE_2D, 1, u, t.width, t.height) : d.texImage2D(e.TEXTURE_2D, 0, u, t.width, t.height, 0, c, l, null));
							...
							if (g) {
								if (v) {
									if (n.layerUpdates.size > 0) {
										let t = Ba(f.width, f.height, n.format, n.type);
				...
				if (g) {
					if (_ && d.texStorage3D(e.TEXTURE_2D_ARRAY, y, u, t.width, t.height, t.depth), v) {
						if (n.layerUpdates.size > 0) {
							let r = Ba(t.width, t.height, n.format, n.type);
							for (let i of n.layerUpdates) {
...
var qc = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Jc = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Yc = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			let t = e.cameras[0].viewport, n = new Pi({
				vertexShader: qc,
				fragmentShader: Jc,
				uniforms: {
			...
			this.mesh = new qr(new wi(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, f = null, p = null, m = null, h = typeof XRWebGLBinding < "u", _ = new Yc(), v = {}, y = t.getContextAttributes(), b = null, S = null, C = [], w = [], T = new K(), k = null, A = new da();
		A.viewport = new Ht();
		let j = new da();
		j.viewport = new Ht();
		let ee = [A, j], M = new ya(), N = null, P = null;
			...
			if (r = l, r !== null) {
				if (b = e.getRenderTarget(), r.addEventListener("select", F), r.addEventListener("selectstart", F), r.addEventListener("selectend", F), r.addEventListener("squeeze", F), r.addEventListener("squeezestart", F), r.addEventListener("squeezeend", F), r.addEventListener("end", te), r.addEventListener("inputsourceschange", ne), y.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(T), h && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					u = this.getBinding(), f = u.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Wt(f.textureWidth, f.textureHeight, {
						format: E,
						type: d,
						depthTexture: new yi(f.textureWidth, f.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
...
}, Zc = /*@__PURE__*/ new qt(), Qc = /*@__PURE__*/ new J();
...
function $c(e, t) {
	...
	function r(t, n) {
		n.color.getRGB(t.fogColor.value, Ai(e)), n.isFog ? (t.fogNear.value = n.near, t.fogFar.value = n.far) : n.isFogExp2 && (t.fogDensity.value = n.density);
	}
...
function rl() {
	return nl === null && (nl = new Xr(tl, 16, 16, j, v), nl.name = "DFG_LUT", nl.minFilter = c, nl.magFilter = c, nl.wrapS = r, nl.wrapT = r, nl.generateMipmaps = !1, nl.needsUpdate = !0), nl;
}
var il = class {
	constructor(e = {}) {
		...
		function rt() {
			R = new So(L), R.init(), et = new Kc(L, R), Ne = new Za(L, R, e, et), z = new Wc(L, R), Ne.reversedDepthBuffer && p && z.buffers.depth.setReversed(!0), re = L.createFramebuffer(), ie = L.createFramebuffer(), ae = L.createFramebuffer(), Pe = new To(L), B = new wc(), V = new Gc(L, R, z, B, Ne, et, Pe), Fe = new xo(F), Le = new Ua(L), tt = new Ya(L, Le), Re = new Co(L, Le, Pe, tt), ze = new Do(L, Re, Le, tt, Pe), Xe = new Eo(L, Ne, V), Ge = new Qa(B), Be = new Cc(F, Fe, R, Ne, tt, Ge), Ve = new $c(F, B), Ue = new Oc(), We = new Fc(R), Ye = new Ja(F, Fe, z, ze, _, s), qe = new Uc(F, ze, Ne), nt = new el(L, Pe, Ne, z), Qe = new Xa(L, R, Pe), $e = new wo(L, R, Pe), Pe.programs = Be.programs, F.capabilities = Ne, F.extensions = R, F.properties = B, F.renderLists = Ue, F.shadowMap = qe, F.state = z, F.info = Pe;
		}
		rt(), S !== 1009 && (P = new ko(S, t.width, t.height, o, r, i));
		let W = new Xc(F, L);
		...
		function wt(e, t, n, r, i) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Xe.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(L, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = rl()), C) {
				...
				Is.upload(L, xt(v), E, V);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (Is.upload(L, xt(v), E, V), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(L, "center", i.center), T.setValue(L, "modelViewMatrix", i.modelViewMatrix), T.setValue(L, "normalMatrix", i.normalMatrix), T.setValue(L, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
...
}, al = { type: "change" }, ol = { type: "start" }, sl = { type: "end" }, cl = new Pr(), ll = new ei(), ul = Math.cos(70 * wt.DEG2RAD), dl = new q(), fl = 2 * Math.PI, $ = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(al), this.update(), this.state = $.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		if (dl.setFromSpherical(this._spherical), dl.applyQuaternion(this._quatInverse), t.copy(this.target).add(dl), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			let e = null;
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = dl.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (cl.origin.copy(this.object.position), cl.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(cl.direction)) < ul ? this.object.lookAt(this.target) : (ll.setFromNormalAndCoplanarPoint(this.object.up, this.target), cl.intersectPlane(ll, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > pl || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > pl || this._lastTargetPosition.distanceToSquared(this.target) > pl ? (this.dispatchEvent(al), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? fl / 60 / 60 * this.autoRotateSpeed : fl / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_panLeft(e, t) {
		dl.setFromMatrixColumn(t, 0), dl.multiplyScalar(-e), this._panOffset.add(dl);
	}
	_panUp(e, t) {
		this.screenSpacePanning === !0 ? dl.setFromMatrixColumn(t, 1) : (dl.setFromMatrixColumn(t, 0), dl.crossVectors(this.object.up, dl)), dl.multiplyScalar(e), this._panOffset.add(dl);
	}
	_pan(e, t) {
		let n = this.domElement;
		if (this.object.isPerspectiveCamera) {
			let r = this.object.position;
			dl.copy(r).sub(this.target);
			let i = dl.length();
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(fl * this._rotateDelta.x / t.clientHeight), this._rotateUp(fl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(fl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-fl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(fl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
			case this.keys.RIGHT: e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(-fl * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(-this.keyPanSpeed, 0), t = !0;
		}
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(fl * this._rotateDelta.x / t.clientHeight), this._rotateUp(fl * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function _l(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(sl), this.state = $.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function vl(t) {
	...
	this.state !== $.NONE && this.dispatchEvent(ol);
}
function yl(e) {
	switch (this.state) {
		case $.ROTATE:
...
function bl(e) {
	this.enabled !== !1 && this.enableZoom !== !1 && this.state === $.NONE && (e.preventDefault(), this.dispatchEvent(ol), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(sl));
}
function xl(e) {
...
//#endregion
//#region skills/yoga-pose-viewer/965e70/widgets/pose-skeleton/src/index.ts
var Dl = [
	"TOP_OF_HEAD",
	...
	"LEFT_WRIST",
	"RIGHT_WRIST",
	"LEFT_CENTRAL_FINGERTIP",
	"RIGHT_CENTRAL_FINGERTIP",
	"LEFT_HIP",
	"RIGHT_HIP",
	"LEFT_KNEE",
	"RIGHT_KNEE",
...
], kl = 15770462, Al = 7258623, jl = 14673134;
function Ml(e) {
	return e.startsWith("LEFT_") ? kl : e.startsWith("RIGHT_") ? Al : jl;
}
...
async function Pl(e, t) {
	...
	try {
		...
		e.innerHTML = `<div class="pose-error">Not readable as JSON: ${String(t)}</div>`;
		let n = document.createElement("style");
		return n.textContent = Nl, e.appendChild(n), () => {};
	}
	if (!n?.landmarks || typeof n.landmarks != "object") return e.innerHTML = "<div class=\"pose-error\">No <code>landmarks</code> in this file.</div>", () => {};
	let r = document.createElement("style");
	r.textContent = Nl, e.appendChild(r);
	let i = document.createElement("div");
	i.className = "pose";
	let a = document.createElement("div");
	a.className = "pose-stage";
	let o = document.createElement("div");
	o.className = "pose-controls", i.append(a, o), e.appendChild(i);
	let s = Dl.filter((e) => !n.landmarks[e]), c = document.createElement("span");
	c.className = "pose-name", c.textContent = n.display_name || n.pose || t.path.split("/").pop() || "Pose";
	let l = document.createElement("label");
	l.className = "pose-toggle";
	let u = document.createElement("input");
	u.type = "checkbox", l.append(u, document.createTextNode("Labels"));
	let d = document.createElement("span");
	if (d.className = "pose-hint", d.textContent = "drag · right-drag · scroll", o.append(c, l, d), s.length > 0) {
		let e = document.createElement("span");
		e.className = "pose-missing", e.title = s.join(", "), e.textContent = `${s.length} missing`, o.appendChild(e);
	}
	let f = new An();
	f.background = new X(t.theme === "light" ? 16054010 : 724242);
	let p = new da(45, 1, .01, 100), m = new il({ antialias: !0 });
	m.setPixelRatio(Math.min(window.devicePixelRatio, 2)), a.appendChild(m.domElement), f.add(new ha(16777215, .75));
	let h = new ma(16777215, 1.1);
	h.position.set(2, 4, 3), f.add(h), f.add(new La(4, 16, 2765378, 1712176)), f.add(new Ra(.3));
	let g = /* @__PURE__ */ new Map();
	for (let e of Dl) {
		let t = n.landmarks[e];
		t && g.set(e, new q(t[0], t[1], t[2]));
	}
	let _ = [], v = new Ti(.035, 20, 16);
	for (let [e, t] of g) {
		let n = new qr(v, new Ii({
			color: Ml(e),
			roughness: .45
		}));
		n.position.copy(t), n.userData.name = e, f.add(n), _.push({
			name: e,
			mesh: n
		});
	}
	for (let [e, t] of Ol) {
		...
		if (!n || !r) continue;
		let i = n.distanceTo(r);
		if (i < 1e-6) continue;
		let a = new qr(new Ci(.016, .016, i, 12), new Ii({
			color: Ml(e.startsWith("LEFT_") || e.startsWith("RIGHT_") ? e : t),
			roughness: .6
		}));
		a.position.copy(n).add(r).multiplyScalar(.5), a.quaternion.setFromUnitVectors(new q(0, 1, 0), r.clone().sub(n).normalize()), f.add(a);
	}
	let y = new Gn();
	for (let e of g.values()) y.expandByPoint(e);
	let b = y.getCenter(new q()), x = new ml(p, m.domElement);
	x.enableDamping = !0, x.dampingFactor = .08, x.target.copy(b);
	let S = y.getSize(new q()), C = () => {
		let e = p.fov * Math.PI / 180, t = S.y / 2 / Math.tan(e / 2), n = Math.max(S.x, S.z) / 2 / (Math.tan(e / 2) * p.aspect), r = Math.max(t, n, .5) * 1.5, i = new q(.55, .28, 1).normalize();
		p.position.copy(b).addScaledVector(i, r), p.near = Math.max(r / 100, .01), p.far = r * 20, p.updateProjectionMatrix(), x.update();
	}, w = !1;
	x.addEventListener("start", () => {
		w = !0;
	});
	let T = new Na(), E = new K(), D = null, O = (e) => {
		let t = m.domElement.getBoundingClientRect();
		E.x = (e.clientX - t.left) / t.width * 2 - 1, E.y = -((e.clientY - t.top) / t.height) * 2 + 1, T.setFromCamera(E, p);
		let n = T.intersectObjects(_.map((e) => e.mesh))[0]?.object.userData.name ?? null;
		n !== D && (D = n, d.textContent = n ? n.toLowerCase() : "drag · right-drag · scroll");
	};
	m.domElement.addEventListener("pointermove", O);
	let k = document.createElement("canvas");
	k.className = "pose-labels", a.appendChild(k);
	let A = k.getContext("2d"), j = () => {
		let e = a.clientWidth, t = a.clientHeight;
		if (!e || !t) return;
		m.setSize(e, t, !1);
		let n = Math.min(window.devicePixelRatio, 2);
		k.width = e * n, k.height = t * n, k.style.width = `${e}px`, k.style.height = `${t}px`, p.aspect = e / t, p.updateProjectionMatrix(), w || C();
	}, ee = new ResizeObserver(j);
	ee.observe(a), j(), C();
	let M = !0, N = () => {
		if (!M || (requestAnimationFrame(N), x.update(), m.render(f, p), !A)) return;
		let e = Math.min(window.devicePixelRatio, 2);
		if (A.setTransform(e, 0, 0, e, 0, 0), A.clearRect(0, 0, k.width, k.height), !(!u.checked && !D)) {
			A.font = "11px ui-monospace, monospace";
			for (let e of _) {
				if (!u.checked && e.name !== D) continue;
				let t = e.mesh.position.clone().project(p);
				if (t.z > 1) continue;
				let n = (t.x + 1) / 2 * a.clientWidth, r = (1 - t.y) / 2 * a.clientHeight, i = e.name.toLowerCase(), o = A.measureText(i).width;
				A.fillStyle = "rgba(11,13,18,0.78)", A.fillRect(n + 8, r - 16, o + 8, 16), A.fillStyle = "#e7e9ee", A.fillText(i, n + 12, r - 4);
			}
		}
	};
	return N(), () => {
		M = !1, ee.disconnect(), m.domElement.removeEventListener("pointermove", O), x.dispose(), m.dispose(), f.traverse((e) => {
			e instanceof qr && (e.geometry.dispose(), e.material.dispose());
		}), e.replaceChildren();
	};
}
//#endregion
